...
var _jsxFileName =
  "/Users/vasileiosgkreen/Projects/react-native-draggable-flatlist/src/components/NestableDraggableFlatList.tsx";
...
function NestableDraggableFlatListInner(props, ref) {
  ...
  if (__DEV__) {
    ...
    var errorWarn = global.console.error;
    global.console.error = function () {
      ...
      for (var error of ignoreWarns) {
        if (arg[0].startsWith(error)) {
          return;
        }
      }
      errorWarn.apply(void 0, arg);
    };
  }
  ...
  var hoverOffset = (0, _reactNativeReanimated.useDerivedValue)(
    (function () {
      ...
      _f.__location =
        "/Users/vasileiosgkreen/Projects/react-native-draggable-flatlist/src/components/NestableDraggableFlatList.tsx (48:38)";
      return _f;
    })(),
    [listHoverOffset]
  );
  (0, _useNestedAutoScroll.useNestedAutoScroll)(
    Object.assign({}, animVals, {
  ...
  return _react.default.createElement(
    ...
    (0, _extends2.default)(
      ...
      props,
      {
        ...
        __self: this,
        __source: { fileName: _jsxFileName, lineNumber: 97, columnNumber: 5 },
      }
    )
  );
}
